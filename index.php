    ...
    <body>
        <div class="container">
			...
			<div class="main">
				...
				<?php
//                                    $otherImage = "[{1300:'images/xxxlarge/3.jpg'},{1000:'images/xxlarge/3.jpg'},{700:'images/xlarge/3.jpg'},{300:'images/large/3.jpg'},{200:'images/medium/3.jpg'},{140:'images/small/3.jpg'}]";
                                    $otherImage = json_encode(array(1300 =>'images/xxxlarge/3.jpg',1000=>'images/xxlarge/3.jpg',700=>'images/xlarge/3.jpg',300=>'images/large/3.jpg',200=>'images/medium/3.jpg',140=>'images/small/3.jpg'));
							...
							<div data-alt="img03" data-description="<h3>Sky high</h3>" data-max-width="1800" data-max-height="1350">
								...
								<noscript>
									<img src="images/xsmall/3.jpg" alt="img03"/>
                                                     ...
                                                     <?php else: ?>
                                                    <div data-description="<h3>Sky high</h3>" data-max-width="1800" data-max-height="1350" data-other-images='<?php echo $otherImage; ?>' >
                                                        <img src="images/medium/3.jpg" alt="img03" />
                                                    </div>
                                                    <?php endif ?>
						</li>
						<?php endfor; ?>
